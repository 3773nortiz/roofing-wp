...
//iVenture - add in new parameter for min_height
	public function buildStyle( $bg_image = '', $bg_color = '', $bg_image_repeat = '', $font_color = '', $padding = '', $margin_bottom = '', $min_height = '' ) {
		$has_image = false;
		$style = '';
...
//iVenture - add in new parameter for min_height START		
		if ( $min_height != '' ) {
			$style .= 'min-height: ' . $min_height . 'px' . ';';
		}
//iVenture - add in new parameter for min_height END
