...
//iVenture - Adding In Field for min_height of primary Row START
		array(
			'type' => 'textfield',
			'heading' => __( 'Row Minimum Height', 'js_composer' ),
			'param_name' => 'min_height',
			'description' => __( 'If you wish to set a minimum height (in px) for this row element enter it here.', 'js_composer' ),
		),
//iVenture - Adding In Field for min_height of primary Row END
		array(
			'type' => 'css_editor',
