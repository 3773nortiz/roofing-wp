...
if(!class_exists('Ultimate_Animation')){
	class Ultimate_Animation{
		...
		function animate_shortcode($atts, $content=null){
			...
			// iVenture - added id to animation div to make it possible to see what you're doing in the front end editor also added css to revo style.css
			$output .= '<div id="ult_animation_vc_css" class="ult-animation '.$el_class.' '.$mobile_opt.'" data-animate="'.$animation.'" data-animation-delay="'.$animation_delay.'" data-animation-duration="'.$animation_duration.'" data-animation-iteration="'.$animation_iteration_count.'" style="'.$style.'" '.$opacity_start_effect_data.'>';
